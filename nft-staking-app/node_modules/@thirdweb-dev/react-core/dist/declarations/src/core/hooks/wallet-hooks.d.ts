import type { BloctoWallet, Coin98Wallet, CoinbaseWallet, CoreWallet, CryptoDefiWallet, EmbeddedWallet, FrameWallet, LocalWallet, MagicEdenWallet, MagicLink, MetaMaskWallet, OKXWallet, OneKeyWallet, PaperWallet, PhantomWallet, RabbyWallet, RainbowWallet, SafeWallet, SmartWallet, TokenBoundSmartWallet, TrustWallet, WalletConnect, XDEFIWallet, walletIds } from "@thirdweb-dev/wallets";
