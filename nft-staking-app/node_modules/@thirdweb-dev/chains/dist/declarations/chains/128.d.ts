declare const _default: {
    ...
    readonly rpc: readonly ["https://huobi-eco-chain.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://128.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://http-mainnet.hecochain.com", "wss://ws-mainnet.hecochain.com"];
