declare const _default: {
    ...
    readonly rpc: readonly ["https://etica.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://61803.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://eticamainnet.eticascan.org", "https://eticamainnet.eticaprotocol.org"];
