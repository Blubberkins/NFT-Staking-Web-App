declare const _default: {
    ...
    readonly rpc: readonly ["https://rinkeby.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://4.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://rinkeby.infura.io/v3/${INFURA_API_KEY}", "wss://rinkeby.infura.io/ws/v3/${INFURA_API_KEY}"];
