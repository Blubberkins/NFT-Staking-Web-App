declare const _default: {
    ...
    readonly rpc: readonly ["https://teleport-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://8001.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://evm-rpc.testnet.teleport.network"];
