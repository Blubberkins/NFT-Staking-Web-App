declare const _default: {
    ...
    readonly rpc: readonly ["https://cic-chain-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://1252.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://testapi.cicscan.com"];
