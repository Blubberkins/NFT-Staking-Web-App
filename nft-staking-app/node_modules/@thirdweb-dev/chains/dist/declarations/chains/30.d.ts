declare const _default: {
    ...
    readonly rpc: readonly ["https://rootstock.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://30.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://public-node.rsk.co", "https://mycrypto.rsk.co"];
