declare const _default: {
    ...
    readonly rpc: readonly ["https://step-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://12345.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://rpc.testnet.step.network"];
