declare const _default: {
    ...
    readonly rpc: readonly ["https://flare-testnet-coston.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://16.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://coston-api.flare.network/ext/bc/C/rpc"];
