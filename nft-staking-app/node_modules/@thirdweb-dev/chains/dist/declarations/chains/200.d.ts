declare const _default: {
    ...
    readonly rpc: readonly ["https://arbitrum-on-xdai.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://200.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://arbitrum.xdaichain.com/"];
