declare const _default: {
    ...
    readonly rpc: readonly ["https://blackfort-exchange-network-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://4777.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://testnet.blackfort.network/rpc"];
