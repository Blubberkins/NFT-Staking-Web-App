declare const _default: {
    ...
    readonly rpc: readonly ["https://kintsugi.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://1337702.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://rpc.kintsugi.themerge.dev"];
