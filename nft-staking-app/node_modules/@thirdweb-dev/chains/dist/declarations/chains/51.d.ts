declare const _default: {
    ...
    readonly rpc: readonly ["https://xdc-apothem-network.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://51.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://rpc.apothem.network", "https://erpc.apothem.network"];
