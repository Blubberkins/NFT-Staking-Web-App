declare const _default: {
    ...
    readonly rpc: readonly ["https://boba-network-rinkeby-testnet.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://28.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://rinkeby.boba.network/"];
