declare const _default: {
    ...
    readonly rpc: readonly ["https://sanr-chain.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://11888.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://sanrchain-node.santiment.net"];
