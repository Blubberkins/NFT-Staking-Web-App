declare const _default: {
    ...
    readonly rpc: readonly ["https://garizon-testnet-stage3.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://903.rpc.thirdweb.com/${THIRDWEB_API_KEY}", "https://s3-testnet.garizon.net/rpc"];
